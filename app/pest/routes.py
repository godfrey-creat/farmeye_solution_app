...
def dashboard():
    ...
    pest_detections = (
        PestControl.query.filter_by(farm_id=farm.id)
        .order_by(PestControl.detection_date.desc())
        .all()
    )

    # Get farm stages
    farm_stages = (
        FarmStage.query.filter_by(farm_id=farm.id)
        .order_by(FarmStage.start_date.desc())
        .all()
    )

    # Get recent pest actions
    recent_actions = (
        PestAction.query.join(PestControl)
        .filter(PestControl.farm_id == farm.id)
        .order_by(PestAction.scheduled_date.desc())
        .limit(5)
        .all()
    )
...
def update_farm_stage():
    ...
    # Create a new stage
    new_stage = FarmStage(
        farm_id=farm.id, stage_name=stage_name, description=description, status="Active"
    )
        ...
        "Corn": [
            {
                ...
                "description": "Attacks corn ears and kernels, causing significant damage to yield.",
            },
            {
                "name": "European Corn Borer",
                "severity": "High",
                "image": "corn_borer.jpg",
                "description": "Bores into stalks, disrupting water and nutrient transport.",
            },
            {
                "name": "Corn Rootworm",
                "severity": "Medium",
                "image": "rootworm.jpg",
                "description": "Damages root systems, leading to lodging and reduced uptake of nutrients.",
            },
            {
                "name": "Armyworm",
                "severity": "Medium",
                "image": "armyworm.jpg",
                "description": "Feeds on foliage, can rapidly defoliate plants.",
            },
        ],
        "Wheat": [
            {
                "name": "Hessian Fly",
                "severity": "High",
                "image": "hessian_fly.jpg",
                "description": "Damages stems, causing plants to break and lodge.",
            },
            {
                "name": "Wheat Stem Sawfly",
                "severity": "Medium",
                "image": "sawfly.jpg",
                "description": "Larvae bore into stems, weakening plants and causing lodging.",
            },
            {
                "name": "Aphids",
                "severity": "Medium",
                "image": "aphids.jpg",
                "description": "Suck plant sap and can transmit viral diseases.",
            },
        ],
        "Soybean": [
            {
                ...
                "description": "Sucks plant sap, reducing vigor and yield.",
            },
            {
                "name": "Bean Leaf Beetle",
                "severity": "Medium",
                "image": "bean_beetle.jpg",
                "description": "Feeds on leaves, pods, and can transmit bean pod mottle virus.",
            },
            {
                "name": "Soybean Cyst Nematode",
                "severity": "High",
                "image": "cyst_nematode.jpg",
                "description": "Damages roots, reducing water and nutrient uptake.",
            },
        ],
        "Rice": [
            {
                ...
                "severity": "High",
                "image": "rice_weevil.jpg",
                "description": "Larvae feed on roots, reducing yield and plant vigor.",
            },
            {
                "name": "Rice Stem Borer",
                "severity": "High",
                "image": "stem_borer.jpg",
                "description": 'Bores into stems, causing "whitehead" and empty panicles.',
            },
            {
                "name": "Rice Leafhopper",
                "severity": "Medium",
                "image": "leafhopper.jpg",
                "description": "Sucks sap and can transmit viral diseases.",
            },
        ],
        "Cotton": [
            {
                ...
                "description": "Damages cotton bolls, severely reducing yield.",
            },
            {
                "name": "Cotton Aphid",
                "severity": "Medium",
                "image": "cotton_aphid.jpg",
                "description": "Sucks plant sap and produces honeydew that leads to sooty mold.",
            },
            {
                "name": "Pink Bollworm",
                "severity": "High",
                "image": "pink_bollworm.jpg",
                "description": "Larvae feed inside bolls, damaging lint and seeds.",
            },
        ],
    }
    ...
    default_pests = [
        {
            ...
            "severity": "Medium",
            "image": "aphids.jpg",
            "description": "Common sap-sucking pests that affect many crops.",
        },
        {
            "name": "Spider Mites",
            "severity": "Medium",
            "image": "spider_mites.jpg",
            "description": "Tiny pests that cause stippling and yellowing of leaves.",
        },
        {
            "name": "Caterpillars",
            "severity": "High",
            "image": "caterpillars.jpg",
            "description": "Voracious leaf-eaters that can quickly defoliate plants.",
        },
        {
            "name": "Thrips",
            "severity": "Low",
            "image": "thrips.jpg",
            "description": "Small insects that damage leaves and flowers by scraping surface cells.",
        },
    ]
